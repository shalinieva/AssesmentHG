...
public class Altoro extends BaseClass{
	...
	@Test()
	public void tc1(String user, String pass, String user1, String pass1) throws InterruptedException {
		launchBrowser();
		maximizeWindow();
...
//		System.out.println("tc1 fail..........");
	...
	@Test()
	public void tc2(String user, String pass) throws InterruptedException {
		launchBrowser();
		maximizeWindow();
		launchUrl("http://testfire.net/index.jsp");
		implicitwait();
	...
	//tc3 to validate transaction details message after fund transfer
	@org.testng.annotations.Parameters({"username1","password1"})
	@Test()
	public void tc3(String user, String pass) throws InterruptedException {
		launchBrowser();
		maximizeWindow();
		launchUrl("http://testfire.net/index.jsp");
		implicitwait();
...
//		System.out.println("tc3 fail..........");
	...
	@org.testng.annotations.Parameters({"username1","password1"})
	@Test()
	public void tc4(String user, String pass) throws InterruptedException {
		launchBrowser();
		maximizeWindow();
		launchUrl("http://testfire.net/index.jsp");
implicitwait();
...
Thread.sleep(2000);
	...
	@org.testng.annotations.Parameters({"username1","password1"})
	@Test()
	public void tc6(String user, String pass) throws InterruptedException {
		launchBrowser();
		maximizeWindow();
		launchUrl("http://testfire.net/index.jsp");
		implicitwait();
